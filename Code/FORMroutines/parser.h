...
id Quark(-1,v?) = Quark(99,v);
id Qbar(-3,v?) = Qbar(97,v);
id Quark2(-7,v?) = Quark2(93,v);
id Qbar2(-9,v?) = Qbar2(91,v);
id V(-5,v?) = V(95,v);
id gluon(-3,v?) = gluon(97, v);
id gluon(-9,v?) = gluon(91, v);
endargument;
...
argument pol, v3, v4, v5;
id Quark(-1,v?) = Quark(99,v);
id Qbar2(-3,v?) = Qbar2(97,v);
id Qbar(-7,v?) = Qbar(93,v);
id Quark2(-9,v?) = Quark2(91,v);
id V(-5,v?) = V(95,v);
id gluon(-3,v?) = gluon(97, v);
id gluon(-9,v?) = gluon(91, v);
endargument;
...
#do j1 =  99,89,-2
    ...
    id Quark2('j1', p1?) = Quark2('j1', p1, i'j1');
    id Qbar('j1', p1?) = Qbar('j1',p1, i'j1');
    id Qbar2('j1', p1?) = Qbar2('j1',p1, i'j1');
...
id prop(Quark2('j1','j2',v?)) = pQuark2(i'j1',i'j2','j1',v,'j2');
...
id v3(Qbar2(n1?,mom1?,i1?),gluon(mu2?,mom2?,a2?),Quark2(n3?,mom3?,i3?)) = 
    vQQg(i1,a2,i3,n1,mu2,n3);
id v3(Qbar2(n1?,mom1?,i1?),Z(?x),Quark2(n3?,mom3?,i3?)) = 
    vQQZ(i1,i3,n1,mu95,n3);
id v3(Qbar2(n1?,mom1?,i1?), photon(mu2?,mom2?),Quark2(n3?,mom3?,i3?)) =
    vQQp(i1,i3,n1,mu2,n3);
id v3(Qbar2(n1?,mom1?,i1?), V(mu2?,mom2?),Quark2(n3?,mom3?,i3?)) =
  vQQV(i1,i3,n1,mu2,n3);
