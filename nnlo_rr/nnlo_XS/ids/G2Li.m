...
{Log[1 + t] -> Log[1 + t], G[1, t^2] -> Log[1 - z], 
 ...
 G[r, -r, t] -> Pi^2/12 - Log[2]^2/2 + 
  ...
  -1/2*Log[1 + u]^2 + Log[1 + u]*(-Log[1 + t/r] - Log[u] + Log[1 + u] + 
     Log[y] + Log[1 - z]) - PolyLog[2, (r*(r - t))/(1 + r^2)] - 
   PolyLog[2, -u], G[r^(-1), -r, t] -> Pi^2/6 + Log[u]*Log[1 + u] - 
   Log[1 + u]^2/2 - Log[u]*(-Log[1 + r*t] + Log[1 + u] + Log[1 - y] + 
     Log[1 - z]) + Log[1 + u]*(-Log[1 + r*t] + Log[1 + u] + Log[1 - y] + 
     Log[1 - z]) - PolyLog[2, (1 - r*t)/(1 + r^2)] + PolyLog[2, -u], 
 ...
 G[-((r*(r + t))/(1 - r*t)), (-2*r*t)/(1 - r*t), 1] -> 
  -1/12*Pi^2 + Log[2]^2/2 + Log[2]*Log[u] - Log[2]*Log[1 + u] - 
   ...
   Log[1 + t/r]*Log[1 + u] - Log[u]*Log[1 + u] + Log[1 + u]^2/2, 
 G[-r, -r, t] -> Log[1 + t/r]^2/2, G[-r, 0, t] -> 
  (Log[1 + t/r]*Log[z])/2 + PolyLog[2, -(t/r)], 
 G[-r^(-1), -r^(-1), t] -> Log[1 + r*t]^2/2, 
 G[0, r^(-1), t] -> -PolyLog[2, r*t], G[0, r, t] -> -PolyLog[2, t/r], 
 G[0, -r^(-1), t] -> -PolyLog[2, -(r*t)], G[-r^(-1), 0, t] -> 
  (Log[1 + r*t]*Log[z])/2 + PolyLog[2, -(r*t)], 
 G[0, -r, t] -> -PolyLog[2, -(t/r)], 
 G[-r, r, t] -> Pi^2/12 - Log[2]^2/2 + Log[2]*(Log[1 + t/r] + Log[u]/2) - 
   (Log[2]*Log[u])/2 - PolyLog[2, (r + t)/(2*r)], 
 G[-r^(-1), r^(-1), t] -> Pi^2/12 - Log[2]^2/2 + Log[2]*Log[1 + r*t] - 
   PolyLog[2, (1 + r*t)/2], G[-r^(-1), r, t] -> 
  (-2*Log[1 + t/r]*Log[1 + r*t] - 2*Log[1 + r*t]*Log[u] + 
    2*Log[1 + t/r]*Log[1 + u] + 2*Log[1 + r*t]*Log[1 + u] + 
    2*Log[u]*Log[1 + u] - Log[1 + u]^2 + 2*Log[1 + r*t]*Log[y] - 
    2*Log[1 + u]*Log[y] + 2*Log[1 + r*t]*Log[1 - z] - 
    2*Log[1 + u]*Log[1 - z] + 2*PolyLog[2, (r*(r - t))/(1 + r^2)] + 
    2*PolyLog[2, -u])/2, G[-r, r^(-1), t] -> 
  (-Pi^2 - 6*Log[1 + t/r]*Log[1 + r*t] - 6*Log[1 + r*t]*Log[u] + 
    6*Log[1 + t/r]*Log[1 + u] + 6*Log[1 + r*t]*Log[1 + u] - 3*Log[1 + u]^2 + 
    6*Log[1 + t/r]*Log[1 - y] + 6*Log[u]*Log[1 - y] - 
    6*Log[1 + u]*Log[1 - y] + 6*Log[1 + t/r]*Log[1 - z] + 
    6*Log[u]*Log[1 - z] - 6*Log[1 + u]*Log[1 - z] + 
    6*PolyLog[2, (1 - r*t)/(1 + r^2)] - 6*PolyLog[2, -u])/6, 
 PolyLog[3, z^2] -> 4*(PolyLog[3, -z] + PolyLog[3, z])}
