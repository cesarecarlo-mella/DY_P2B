...
{H[1, IF1] -> (eps^2*Pi^2)/16 + G[-I, r]*((-3*eps^2*G[r^(-1), t])/8 + 
 ...
 H[2, IF3] -> (eps^2*Pi^2)/6 + G[0, t]*(-eps - 2*eps^2*G[-I, r] - 
   ...
   G[-1, t^2]*((3*eps)/2 + (3*eps^2*Log[2])/2) + 
   (eps^2*(-Pi^2 + 16*Log[2]^2))/8, 
 H[3, IF3] -> -0.567998252057085515147323098740474752075361142574447122449071\
8290612395806719786153745843124526726923236845709706803`96.45331700356266*
    eps^2 + G[0, t]*((-5*eps)/2 - 6*eps^2*G[-I, r] - 6*eps^2*G[I, r]) + 
   G[-I, r]*((-3*eps)/2 - (3*eps^2*G[-r, t])/2 - (3*eps^2*G[r, t])/2) + 
   G[I, r]*((-3*eps)/2 - (3*eps^2*G[-r, t])/2 - (3*eps^2*G[r, t])/2) + 
   G[0, r]*(-1/2*eps - 4*eps^2*G[0, t] - (eps^2*G[-r, t])/2 + 
     (3*eps^2*G[r, t])/2) + (23*eps^2*G[-1, -1, t^2])/2 + 
   (5*eps^2*G[-1, 0, t^2])/2 + (5*eps^2*G[0, -1, t^2])/2 + eps^2*G[0, 0, r] - 
   11*eps^2*G[0, 0, t] + 5*eps^2*G[0, 0, t^2] - 3*eps^2*G[0, -I, r] - 
   3*eps^2*G[0, I, r] - (3*eps^2*G[0, -r^(-1), t])/2 - 
   ...
   (eps^2*G[r, t]*Log[2])/2 + G[-r, t]*(-1/2*eps + (eps^2*Log[2])/2) + 
