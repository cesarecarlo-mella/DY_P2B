 ...
 CF^2*
  ((((-1 + z)*(1 + z)^2*(y + z - y*z + Sqrt[(z*(y + z - y*z))/
     ...
     ((delta[1 - y]*(-6 + Log[256] - 8*(-Log[z] + Log[1 + z])))/z + 
       (delta[y]*(-6 + Log[256] - 8*(-Log[z] + Log[1 + z])))/z)*P[1 - z, 0] + 
     P[y, 0]*((-2*(1 + z)*(y + z - y*z + Sqrt[(z*(y + z - y*z))/
            (1 + y*(-1 + z))]))/((1 + y*(-1 + z))*(y*(-1 + z) - z)*z) + 
       (4*(y + z - y*z + Sqrt[(z*(y + z - y*z))/(1 + y*(-1 + z))])*
         P[1 - z, 0])/((y*(-1 + z) - z)*z)) + 
     P[1 - y, 0]*((2*(1 + z)*(y + z - y*z + Sqrt[(z*(y + z - y*z))/
            (1 + y*(-1 + z))]))/(z*(y + z - y*z)^2) + 
       (4*(y + z - y*z + Sqrt[(z*(y + z - y*z))/(1 + y*(-1 + z))])*
         P[1 - z, 0])/((y*(-1 + z) - z)*z)) + 
     ((-8*delta[1 - y])/z - (8*delta[y])/z)*P[1 - z, 1])/ep + 
   (-(((-1 + z)*(1 + z)^2*(y + z - y*z + Sqrt[(z*(y + z - y*z))/
           (1 + y*(-1 + z))]))/((y + z - y*z)^2*(z + y*(-1 + z)*z))) + 
     ((1 + z)*delta[1 - y]*(-3 + Log[16] - 4*Log[1 - z] + 4*Log[z] - 
        4*Log[1 + z]))/z + ((1 + z)*delta[y]*(-3 + Log[16] - 4*Log[1 - z] + 
     ...
     ((delta[1 - y]*(6 - 8*Log[2] - 8*Log[z] + 8*Log[1 + z]))/z + 
       (delta[y]*(6 - 8*Log[2] - 8*Log[z] + 8*Log[1 + z]))/z)*P[1 - z, 0] + 
     P[y, 0]*((2*(1 + z)*(y + z - y*z + Sqrt[(z*(y + z - y*z))/
            (1 + y*(-1 + z))]))/((1 + y*(-1 + z))*(y*(-1 + z) - z)*z) - 
       (4*(y + z - y*z + Sqrt[(z*(y + z - y*z))/(1 + y*(-1 + z))])*
         P[1 - z, 0])/((y*(-1 + z) - z)*z)) + 
     P[1 - y, 0]*((-2*(1 + z)*(y + z - y*z + Sqrt[(z*(y + z - y*z))/
       ...
       (4*(y + z - y*z + Sqrt[(z*(y + z - y*z))/(1 + y*(-1 + z))])*
         P[1 - z, 0])/((y*(-1 + z) - z)*z)) + 
     ((8*delta[1 - y])/z + (8*delta[y])/z)*P[1 - z, 1])/ep^2)
